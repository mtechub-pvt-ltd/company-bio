...
function UserFollowing({ user_id }) {
    ...
    const getUserFollowings = async (user_id) => {

        var InsertAPIURL = `${url}follwers/getFollowings?follower_id=${user_id}`
            ...
            <Box sx={{ backgroundColor: "white", borderRadius: "14px", mt: 2, ml: 2, mr: 2 }}>
                <Grid container spacing={0}  >
                    <Grid xs={6} md={6} align="center" p={1}>
                        <TypographyMD variant='h2' label="Followings" color="#424242" fontFamily="Nunito Sans" marginLeft={0} fontSize="25px" fontWeight={550} align="left" />
                    </Grid>
