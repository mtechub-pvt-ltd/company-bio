...
function WalletHistory({ user_id }) {
    ...
    const getUserWalletHistory = async (user_id) => {
        try {
            const response = await fetch(`${url}wallet/getTransactionHistory?user_id=${user_id}`, {
                method: 'GET',
                headers: {
    ...
    const handleFilterSelect = (filter) => {
        ...
        if (filter === 'A-Z') {
            ...
            sortedRows.sort((a, b) =>
                (b.transaction_id?.toString() || '').localeCompare(a.transaction_id?.toString() || '')
            );
        }
            ...
            <Box sx={{ backgroundColor: "white", borderRadius: "14px", mt: 2, ml: 2, mr: 2 }}>
                <Grid container spacing={0}  >
                    <Grid xs={6} md={6} align="center" p={1}>
                        <TypographyMD variant='h2' label="Wallet History" color="#424242" fontFamily="Nunito Sans" marginLeft={0} fontSize="25px" fontWeight={550} align="left" />
                    </Grid>
                                ...
                                <TableContainer
                                    ...
                                    <Table sx={{ minWidth: { xs: "100px", md: '250px' } }} aria-label="simple table">
                                        <TableHead style={{ backgroundColor: '#F4F6FA' }}>
                                            <TableRow  >
                                                <TableCell align="center" sx={{ fontWeight: "bold", color: "#424242", fontFamily: "Nunito Sans", fontSize: "15px" }}> TRANSACTION ID </TableCell>
                                                <TableCell align="center" sx={{ fontWeight: "bold", color: "#424242", fontFamily: "Nunito Sans", fontSize: "15px" }}> PAYMENT TYPE </TableCell>
                                                <TableCell align="center" sx={{ fontWeight: "bold", color: "#424242", fontFamily: "Nunito Sans", fontSize: "15px" }}> TRANSACTION TYPE </TableCell>
                                                <TableCell align="center" sx={{ fontWeight: "bold", color: "#424242", fontFamily: "Nunito Sans", fontSize: "15px" }}> AMOUNT </TableCell>
                                            ...
                                            {displayedRows?.map((item) => (
                                                <TableRow>
                                                    ...
                                                    <TableCell align="center" sx={{ fontWeight: "normal", color: "#545454", fontFamily: "Nunito Sans", fontSize: "13px" }} >
                                                        # {highlightMatch((item?.transaction_id || '').toString(), searchTerm)}
                                                    </TableCell>

                                                    <TableCell align="center" sx={{ fontWeight: "normal", color: "#545454", fontFamily: "Nunito Sans", fontSize: "13px" }} >{item?.payment_type}</TableCell>
                                                    <TableCell align="center" sx={{ fontWeight: "normal", color: "#545454", fontFamily: "Nunito Sans", fontSize: "13px" }} >
                                                        <Box
                                                            sx={{
                                                    ...
                                                    <TableCell align="center" sx={{ fontWeight: "normal", color: "#545454", fontFamily: "Nunito Sans", fontSize: "13px" }} >$ {item?.amount}</TableCell>
                                                    <TableCell align="center" sx={{ fontWeight: "normal", color: "#545454", fontFamily: "Nunito Sans", fontSize: "13px" }} >
                                                        <>
